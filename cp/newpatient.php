                    ...
                    <div class="card-body">
                        <form action="addnewpatient.php" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <input required type="number" min="1" value="1" class="form-control" id="inputZip" name="weight">
                                </div>
                                <div class="form-group col-md-2">
                                <label for="inputZip">height</label>
                                <input required type="number" min="1" value="1" class="form-control" id="inputZip" name="height">
                                </div>
                                <div class="form-group col-md-6">
